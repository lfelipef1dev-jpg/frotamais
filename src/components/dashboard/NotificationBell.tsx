  ...
  return (
    <div className="relative">
      <button
        ...
        aria-label={`Notificações: ${pending.length} pendentes`}
      >
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-full mt-2 w-80 bg-white border border-brand-border rounded-2xl shadow-2xl z-50 max-h-96 overflow-y-auto">
            <div className="px-4 py-3 border-b border-brand-border">
              <p className="font-bold text-sm text-brand-text">Notificações</p>
            ...
            <div className="divide-y divide-brand-border">
              ...
              {pending.length === 0 && (
                <div className="px-4 py-8 text-center text-sm text-brand-text-secondary">Nenhuma notificação pendente.</div>
              )}
            </div>
